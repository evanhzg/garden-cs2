...
public class UserSetting
{
    ...
    /// <summary>
    /// The Zeus preference is team-agnostic and persisted inside the WeaponPreferences
    /// storage under the pseudo allocation type WeaponAllocationType.Zeus.
    /// </summary>
    public void SetZeusPreference(bool enabled)
    {
        CsItem? value = enabled ? CsItem.Zeus : null;
        SetWeaponPreference(CsTeam.Terrorist, WeaponAllocationType.Zeus, value);
        SetWeaponPreference(CsTeam.CounterTerrorist, WeaponAllocationType.Zeus, value);
    }

    public bool GetZeusPreference()
    {
