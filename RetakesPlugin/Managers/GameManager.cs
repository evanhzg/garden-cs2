...
public class GameManager
{
    ...
    {
        // Garden (R12): CR matches own the sides — no rotation/scramble/balance.
        if (_plugin.SuspendTeamManagement)
        {
            Logger.LogDebug("GameManager", "Team management suspended (CR) — skipping rotation/balance.");
            return;
        }
