...
/// <summary>
/// Native grenade-projectile Create functions (signature-scanned), ported from
/// MatchZy (github.com/shobhit-pathak/MatchZy — GrenadeProjectiles.cs). These call
/// the game's own <c>CXGrenadeProjectile::Create()</c> statics so a spawned nade
/// flies the recorded trajectory AND detonates like a real throw (CreateEntityByName
/// can't — smoke/molotov/HE just bounce forever). Signatures are game-build specific;
/// if a CS2 update breaks executes/fast-strat utility, refresh from MatchZy's latest.
/// </summary>
