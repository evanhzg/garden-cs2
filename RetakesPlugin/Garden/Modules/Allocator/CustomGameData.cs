...
public class CustomGameData
{
    ...
    public void LoadCustomGameData()
    {
        ...
        {
            // Only used as a fallback: item identification primarily relies on the
            // definition-index mapping in WeaponHelpers.
            Log.Warn($"Failed to load GetCSWeaponDataFromKey signature: {e.Message}");
        }
